...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : MOHAMMAD SHIBLU
    print '\033[1;93mFACEBOOK : MOHAMMAD SHIBLU MIM
    print '\x1b[1;91mFACEBOOK  : HD MIM VAIRAL MAGI
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  GP (SHIBLU PRO)'
    print '\x1b[1;92m[2]  AIRTEL(MIM)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(MIM ER HEDA)'
    print '\x1b[1;92m[6]  TELETALK(MIM ER HEDA)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[SHIBLU-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 10 Days]\x1b[0m \n'
